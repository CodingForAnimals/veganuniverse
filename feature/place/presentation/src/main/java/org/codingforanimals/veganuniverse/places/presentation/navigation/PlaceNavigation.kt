package org.codingforanimals.veganuniverse.places.presentation.navigation
...
import org.codingforanimals.veganuniverse.places.presentation.reviews.PlaceReviewsScreen
...
fun NavGraphBuilder.placesGraph(
    ...
    composable(
        ...
        PlaceDetailsScreen(
            ...
            navigateToReviewsScreen = { id, name, rating, userId ->
                navController.navigate("${PlaceDestination.Reviews.route}/$id/$name/$rating/$userId")
            }
        )
    }
    ...
    composable(
        ...
        PlaceReviewsScreen(
            ...
            rating = it.arguments?.getInt(selected_place_rating),
