package org.codingforanimals.veganuniverse.recipes.presentation.create.composables
        ...
        stepsField.list.forEachIndexed { index, step ->
            key(index) {
                Row(
                    ...
                    val imeAction =
                        if (index == stepsField.list.lastIndex) ImeAction.Done else ImeAction.Next
                    VUNormalTextField(
