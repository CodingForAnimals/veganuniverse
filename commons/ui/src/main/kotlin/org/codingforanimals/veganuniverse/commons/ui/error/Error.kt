package org.codingforanimals.veganuniverse.commons.ui.error
...
import org.codingforanimals.veganuniverse.commons.ui.icon.VUImages
...
private fun PreviewErrorView() {
    VeganUniverseBackground {
        Surface {
            ErrorView(message = R.string.unexpected_error_message)
        }
    }
}